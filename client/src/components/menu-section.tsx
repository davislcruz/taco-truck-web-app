                  ...
                  {filteredItems.length > 1 && (
                    <>
                      <Button
                        variant="outline"
                        size="icon"
                        className="absolute left-0 top-1/2 -translate-y-1/2 -mt-2.5 xxs:-mt-5 xs:-mt-2.5 bg-white/70 hover:bg-white/90 shadow-lg"
                        onClick={(e) => {
                          e.stopPropagation();
                      ...
                      <Button
                        variant="outline"
                        size="icon"
                        className="absolute right-0 top-1/2 -translate-y-1/2 -mt-2.5 xxs:-mt-5 xs:-mt-2.5 bg-white/70 hover:bg-white/90 shadow-lg"
                        onClick={(e) => {
                          e.stopPropagation();
