  ...
  return (
    <>
      ...
      <section className="relative bg-gradient-to-br from-amber-900 via-red-800 to-orange-900 text-white py-8 overflow-hidden">
        {/* Papel Picado Banner */}
        <div className="absolute top-0 left-0 w-full h-8 bg-gradient-to-r from-pink-500 via-yellow-400 via-green-500 via-emerald-400 via-blue-500 to-purple-500 opacity-80">
          <svg className="w-full h-full" viewBox="0 0 400 32" preserveAspectRatio="none">
            <path d="M0,0 L20,0 L25,8 L30,0 L50,0 L55,8 L60,0 L80,0 L85,8 L90,0 L110,0 L115,8 L120,0 L140,0 L145,8 L150,0 L170,0 L175,8 L180,0 L200,0 L205,8 L210,0 L230,0 L235,8 L240,0 L260,0 L265,8 L270,0 L290,0 L295,8 L300,0 L320,0 L325,8 L330,0 L350,0 L355,8 L360,0 L380,0 L385,8 L390,0 L400,0 L400,32 L0,32 Z" fill="currentColor"/>
          </svg>
        </div>
