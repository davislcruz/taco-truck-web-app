...
```
Changelog:
- July 2, 2025. Updated category icons - changed burritos from wrap-text to beef icon, changed semitas from cookie to sandwich icon (same as tortas), changed bebidas from coffee to glass-water icon for better food/drink representation
